package cn.srd.library.java.web.openfeign.interceptor;
...
import cn.srd.library.java.web.openfeign.autoconfigue.EnableOpenFeignClientResponseModelResolver;
    ...
    public String resolve(String responseBody) {
        ...
        if (Nil.isNull(responseModel)) {
            throw new LibraryJavaInternalException(Strings.format(
                    ...
                    cn.srd.library.java.tool.lang.convert.Converts.toList(OpenFeignClientResponseModelCache.get(), Classes::getClassFullName),
                    responseBody
            ));
        }
