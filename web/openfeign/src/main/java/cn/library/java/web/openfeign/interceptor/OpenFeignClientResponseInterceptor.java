package cn.library.java.web.openfeign.interceptor;
...
import cn.library.java.web.openfeign.autoconfigue.EnableOpenFeignClientResponseModelResolver;
import cn.library.java.web.openfeign.cache.OpenFeignClientResponseModelCache;
    ...
    public String resolve(String responseBody) {
        ...
        if (Nil.isNull(responseModel)) {
            throw new LibraryJavaInternalException(Strings.format(
                    ...
                    cn.library.java.tool.lang.convert.Converts.toList(OpenFeignClientResponseModelCache.get(), Classes::getClassFullName),
                    responseBody
            ));
        }
