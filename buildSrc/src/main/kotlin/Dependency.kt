enum class GradleDependency(val withoutVersion: String, val version: String) {
    ...
    BOM_CACHE_REDISSON("org.redisson:redisson-parent", "3.47.0"), // TODO wjm support spring-boot version to 3.4.2
    ...
    BOM_ECLIPSE_PAHO("org.eclipse.paho:java-parent", "1.2.5"), // support spring-integration-mqtt version to 6.5.0
    ...
    BOM_FRAMEWORK_SPRING("org.springframework:spring-framework-bom", "6.2.10"), // support spring-boot version to 3.5.5
    BOM_FRAMEWORK_SPRING_BOOT("org.springframework.boot:spring-boot-dependencies", "3.5.5"),
    BOM_FRAMEWORK_SPRING_CLOUD("org.springframework.cloud:spring-cloud-dependencies", "2025.0.0"), // TODO wjm support spring-boot version to 3.5.0
    BOM_FRAMEWORK_SPRING_INTEGRATION("org.springframework.integration:spring-integration-bom", "6.5.1"), // support spring-boot version to 3.5.5
    BOM_JDBC_POSTGIS("net.postgis:postgis-java-aggregator", "2024.1.0"),
    BOM_METRIC_DROPWIZARD("io.dropwizard.metrics:metrics-bom", "4.2.28"), // support spring-boot version to 3.5.5
    BOM_METRIC_MICROMETER("io.micrometer:micrometer-bom", "1.15.3"), // support spring-boot version to 3.5.5
    BOM_ORM_MYBATIS_FLEX("com.mybatis-flex:mybatis-flex-dependencies", "1.11.1"), // TODO wjm support spring-boot version to 2.7.11
    BOM_ORM_MYBATIS_PLUS("com.baomidou:mybatis-plus-bom", "3.5.14"), // support spring-boot version to 3.5.5
    BOM_OSS_ALL_FACED("org.dromara.x-file-storage:x-file-storage-parent", "2.2.1"), // TODO wjm support spring-boot version to 2.7.2
    BOM_SECURITY_DEV33_SA_TOKEN("cn.dev33:sa-token-bom", "1.44.0"), // TODO wjm support spring-boot version to 3.0.1
    BOM_TEST_MOCKITO("org.mockito:mockito-bom", "5.17.0"), // support spring-boot version to 3.5.5
    ...
    BOM_TOOL_MAPSTRUCT_PLUS("io.github.linpeilie:mapstruct-plus-pom", "1.5.0"), // TODO wjm support spring-boot version to 2.7.18
    ...
    BOM_TOOL_SERIALIZATION_FASTERXML_JACKSON("com.fasterxml.jackson:jackson-bom", "2.19.2"), // support spring-boot version to 3.5.5
    ...
    BOM_WEB_FEIGN("io.github.openfeign:feign-bom", "13.6"), // support spring-cloud version to 2025.0.0
    BOM_WEB_GRPC("io.grpc:grpc-bom", "1.63.0"), // need to synchronize with "net.devh:grpc-spring-boot-starter"
    BOM_WEB_NETTY("io.netty:netty-bom", "4.1.124.Final"), // support spring-boot version to 3.5.5
    BOM_WEB_REACTOR("io.projectreactor:reactor-bom", "2024.0.9"), // support spring-boot version to 3.5.5

    CACHE_CAFFEINE("com.github.ben-manes.caffeine:caffeine", "3.2.2"), // support spring-boot version to 3.5.5
    CACHE_LETTUCE("io.lettuce:lettuce-core", "6.5.5.RELEASE"), // support spring-boot version to 3.5.5
    ...
    JDBC_HSQLDB("org.hsqldb:hsqldb", "2.7.3"), // support spring-boot version to 3.5.5
    JDBC_MARIADB("org.mariadb.jdbc:mariadb-java-client", "3.5.2"),
    JDBC_MYSQL("com.mysql:mysql-connector-j", "9.4.0"), // support spring-boot version to 3.5.5
    JDBC_POSTGIS("net.postgis:postgis-jdbc-jts", BOM_JDBC_POSTGIS.version), // TODO wjm bom is not invalid
    JDBC_POSTGRESQL("org.postgresql:postgresql", "42.7.7"), // support spring-boot version to 3.5.5
    JDBC_SQL_SERVER("com.microsoft.sqlserver:mssql-jdbc", "12.10.1.jre11"), // support spring-boot version to 3.5.5
    ...
    ORM_MYBATIS("org.mybatis.spring.boot:mybatis-spring-boot-starter", "3.0.4"), // need to synchronize with "com.mybatis-flex:mybatis-flex-dependencies"
    ...
    PLUGGABLE_ANNOTATION_PROCESSING_API_LOMBOK("org.projectlombok:lombok", "1.18.38"), // support spring-boot version to 3.5.5
    ...
    POOL_DATABASE_HIKARICP("com.zaxxer:HikariCP", "6.3.2"), // support spring-boot version to 3.5.5
    POOL_APACHE("org.apache.commons:commons-pool2", "2.12.1"), // support spring-boot version to 3.5.5
    ...
    TOOL_JOB_QUARTZ("org.quartz-scheduler:quartz", "2.5.0"), // support spring-boot version to 3.5.5
    ...
    TOOL_VALIDATION_HIBERNATE("org.hibernate.validator:hibernate-validator", "8.0.3.Final"), // support spring-boot version to 3.5.5
    TOOL_VALIDATION_JAKARTA("jakarta.validation:jakarta.validation-api", "3.0.2"), // support spring-boot version to 3.5.5
    ...
    TEST_JUNIT("org.junit.jupiter:junit-jupiter-api", "5.12.1"), // support spring-boot version to 3.5.5
