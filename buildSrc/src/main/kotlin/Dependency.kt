...
enum class GradleDependency(val withoutVersion: String, val version: String) {
    ...
    BOM_FRAMEWORK_SPRING_CLOUD("org.springframework.cloud:spring-cloud-dependencies", "2022.0.4"), // TODO wjm spring-boot version 3.0.9
    ...
    BOM_WEB_FEIGN("io.github.openfeign:feign-bom", "13.1"),
