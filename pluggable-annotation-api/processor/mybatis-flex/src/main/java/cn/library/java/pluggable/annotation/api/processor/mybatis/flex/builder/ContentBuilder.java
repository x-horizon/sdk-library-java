...
package cn.library.java.pluggable.annotation.api.processor.mybatis.flex.builder;
...
public class ContentBuilder {
    ...
    public static String buildTableDef(TableInfo tableInfo, boolean allInTablesEnable,
        ...
        content.append("import cn.library.java.orm.mybatis.flex.base.chain.ConstrainedQueryColumn;\n");
