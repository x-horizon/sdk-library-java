...
package org.horizon.library.java.pluggable.annotation.api.processor.mybatis.flex.builder;
...
public class ContentBuilder {
    ...
    public static String buildTableDef(TableInfo tableInfo, boolean allInTablesEnable,
        ...
        content.append("import org.horizon.library.java.orm.mybatis.flex.base.chain.ConstrainedQueryColumn;\n");
        // content.append("import com.mybatisflex.core.query.QueryColumn;\n");
        content.append("import com.mybatisflex.core.table.TableDef;\n\n");
        // wjm using customer component.
        content.append("// Auto generate by library-orm-mybatis-flex, do not modify it.\n");
