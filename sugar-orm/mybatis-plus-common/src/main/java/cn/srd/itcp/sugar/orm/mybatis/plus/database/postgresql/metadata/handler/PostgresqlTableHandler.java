package cn.srd.itcp.sugar.orm.mybatis.plus.database.postgresql.metadata.handler;

import cn.srd.itcp.sugar.framework.spring.tool.common.core.page.PageParam;
import cn.srd.itcp.sugar.framework.spring.tool.common.core.page.PageResult;
import cn.srd.itcp.sugar.orm.mybatis.plus.core.GenericCurdService;
import cn.srd.itcp.sugar.orm.mybatis.plus.core.MpWrappers;
import cn.srd.itcp.sugar.orm.mybatis.plus.database.postgresql.metadata.bean.convert.PostgresqlTableConverter;
import cn.srd.itcp.sugar.orm.mybatis.plus.database.postgresql.metadata.bean.dto.PostgresqlTableDTO;
import cn.srd.itcp.sugar.orm.mybatis.plus.database.postgresql.metadata.bean.po.PostgresqlTablePO;
import cn.srd.itcp.sugar.orm.mybatis.plus.database.postgresql.metadata.bean.vo.PostgresqlTableVO;
import cn.srd.itcp.sugar.orm.mybatis.plus.database.postgresql.metadata.dao.PostgresqlTableDao;
