package cn.srd.itcp.sugar.orm.mybatis.plus.geometry.database.postgresql.utils;
...
public class SQLParser {
    ...
    public static <PO> String replaceSelectSQLToGeometryToString(Class<PO> poClass, String columnName) {
        return replaceSelectSQLToGeometryToString(poClass, TableInfoHelper.getTableInfo(poClass).getAllSqlSelect(), columnName);
    }
     ...
     * @return id, columnName ==&gt; id, ST_ASTEXT(columnName) AS columnName
     */
    public static <PO> String replaceSelectSQLToGeometryToString(Class<PO> poClass, String sql, String columnName) {
