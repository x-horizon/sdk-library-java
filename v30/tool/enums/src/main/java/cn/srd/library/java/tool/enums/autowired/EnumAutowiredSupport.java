...
public class EnumAutowiredSupport {
    ...
    public <E extends Enum<E>> void support() {
        ...
        Assert.of().setMessage(Strings.format("{}could not found the class marked with [@{}] on these paths {}, please check!", ModuleView.ENUM_AUTOWIRED_SYSTEM, EnableEnumAutowired.class.getSimpleName(), BasePackagePath.get(Springs.getSpringBootApplicationPackagePath())))
        ...
        Set<BeanDefinition> enumAutowiredBeanDefinitions = Springs.scanByTypeFilter(new AnnotationTypeFilter(EnumAutowired.class), allScanPackagePaths);
        ...
        enumAutowiredBeanDefinitions.forEach(enumAutowiredBeanDefinition -> {
            ...
            Set<BeanDefinition> enumAutowiredChildrenClassDefinitions = Springs.scanByTypeFilter(new AssignableTypeFilter(enumAutowiredRootClass), allScanPackagePaths);
