...
public class EnumAutowiredTest {
    ...
    public void testEnumAutowired() {
        ...
        Set<BeanDefinition> beanDefinitions = Springs.scanByTypeFilter(Collections.ofArrayList(new AnnotationTypeFilter(EnumAutowired.class), new AssignableTypeFilter(GenderStrategy.class)), basePackage);
    }
