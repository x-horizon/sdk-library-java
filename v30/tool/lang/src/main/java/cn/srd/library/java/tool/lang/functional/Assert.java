...
import cn.srd.library.java.tool.lang.object.Nullable;
...
public class Assert {
     ...
     */
    public <T extends Nullable> void throwsIfNull(T input) {
        Action.<Void>ifNull(input).then(() -> {
            this.message = Objects.setIfNull(this.message, () -> ExceptionMessage.NOT_NULL_CHECKED_MESSAGE);
            return this.doThrows();
        });
    }
     ...
     *
     * @param inputs the checked element
     */
    ...
    /**
     * throws if any of the checked elements is null
     *
     * @param inputs the checked elements
     */
    ...
    /**
     * throws if the checked element is {@link CharSequenceUtil#hasEmpty(CharSequence...)}
     *
     * @param inputs the checked elements
     */
    ...
    /**
     * throws if the checked element is {@link CharSequenceUtil#hasBlank(CharSequence...)}
     *
     * @param inputs the checked elements
     */
    ...
    /**
     * throws if all checked element are null
     *
     * @param inputs the checked elements
     */
    ...
    /**
     * throws if the checked element is {@link CharSequenceUtil#isAllEmpty(CharSequence...)}
     *
     * @param inputs the checked elements
     */
    ...
    /**
     * throws if the checked element is {@link CharSequenceUtil#isAllBlank(CharSequence...)}
     *
     * @param inputs the checked elements
     */
     ...
     * @param <T>   the checked element type
     */
    public <T extends Nullable> void throwsIfNotNull(T input) {
        Action.<Void>ifNotNull(input).then(() -> {
            this.message = Objects.setIfNull(this.message, () -> ExceptionMessage.NULL_CHECKED_MESSAGE);
            return this.doThrows();
        });
    }
    ...
    /**
     * throws if the checked element is not {@link CharSequenceUtil#hasEmpty(CharSequence...)}
     *
     * @param inputs the checked elements
     */
    ...
    /**
     * throws if the checked element is not {@link CharSequenceUtil#hasBlank(CharSequence...)}
     *
     * @param inputs the checked elements
     */
