...
public class Nil {
     ...
     * @return return true if the checked element is null
     */
    public static <T extends Nullable> boolean isNull(T input) {
        return null == input || input.isNull();
    }
    ...
    /**
     * return true if any of the checked elements is null
     *
     * @param inputs the checked elements
     * @return return true if any checked element is null
     */
    ...
    /**
     * return true if all checked element are null
     *
     * @param inputs the checked elements
     * @return return true if all checked element are null
     */
    ...
    /**
     * reverse {@link #isNull(Nullable)}
     *
     * @param input the checked element
     * @param <T>   the checked element type
     * @return return true if the checked elements is not null
     */
    public static <T extends Nullable> boolean isNotNull(T input) {
        return !isNull(input);
    }
