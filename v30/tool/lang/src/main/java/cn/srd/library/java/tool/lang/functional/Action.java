...
public class Action<V> {
     ...
     * @return after infer action
     */
    public static <T extends Nullable> Action<T> ifNull(T input) {
        return infer(Nil.isNull(input));
    }
    ...
    /**
     * infer any of the checked elements is null
     *
     * @param inputs the checked elements
     * @param <T>    the infer value type
     * @return after infer action
    ...
    /**
     * infer all checked element are null
     *
     * @param inputs the checked elements
     * @param <T>    the infer value type
     * @return after infer action
     ...
     * @return after infer action
     */
    public static <T extends Nullable> Action<T> ifNotNull(T input) {
        return infer(Nil.isNotNull(input));
    }
