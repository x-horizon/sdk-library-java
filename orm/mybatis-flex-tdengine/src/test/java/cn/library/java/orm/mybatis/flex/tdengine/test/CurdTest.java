package cn.library.java.orm.mybatis.flex.tdengine.test;
...
import cn.library.java.orm.mybatis.flex.tdengine.config.TestInsertListener;
import cn.library.java.orm.mybatis.flex.tdengine.config.TestUpdateListener;
import cn.library.java.orm.mybatis.flex.tdengine.model.po.HomePO;
import cn.library.java.orm.mybatis.flex.tdengine.model.po.PeoplePO;
import cn.library.java.orm.mybatis.flex.tdengine.model.vo.HomeVO;
import cn.library.java.orm.mybatis.flex.tdengine.model.vo.PeopleVO;
import cn.library.java.orm.mybatis.flex.tdengine.repository.HomeRepository;
import cn.library.java.orm.mybatis.flex.tdengine.repository.PeopleRepository;
import cn.library.java.orm.mybatis.flex.tdengine.service.HomeService;
import cn.library.java.orm.mybatis.flex.tdengine.service.PeopleService;
...
@MapperScan("cn.library.java.orm.mybatis.flex.tdengine.**")
...
@EnableMybatisFlexCustomizer(
        ...
        globalPropertyConfig = @PropertyConfig(
                ...
                xmlMapperClassPaths = {"classpath*:cn/library/java/orm/mybatis/flex/tdengine/repository/impl/*.xml"},
