...
package cn.srd.library.java.orm.mybatis.flex.tdengine.test;
...
import cn.srd.library.java.orm.mybatis.flex.tdengine.config.TestInsertListener;
import cn.srd.library.java.orm.mybatis.flex.tdengine.config.TestUpdateListener;
...
import cn.srd.library.java.orm.mybatis.flex.tdengine.service.HomeService;
import cn.srd.library.java.orm.mybatis.flex.tdengine.service.PeopleService;
...
@MapperScan("cn.srd.library.java.orm.mybatis.flex.tdengine.**")
...
@EnableMybatisFlexCustomizer(
        ...
        globalPropertyConfig = @PropertyConfig(
                ...
                xmlMapperClassPaths = {"classpath*:cn/srd/library/java/orm/mybatis/flex/tdengine/repository/impl/*.xml"},
