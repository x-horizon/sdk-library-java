 ...
 */
public abstract class JavaListEnumIntegerMappingJdbcJsonbTypeHandler<E extends Enum<E>> extends BaseTypeHandler<List<E>> implements JdbcJsonbTypeHandler<E> {
