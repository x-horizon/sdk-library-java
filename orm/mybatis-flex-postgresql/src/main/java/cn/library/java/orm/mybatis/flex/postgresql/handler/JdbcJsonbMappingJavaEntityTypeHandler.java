...
import cn.library.java.orm.mybatis.contract.postgresql.handler.JdbcJsonbMappingJavaObjectTypeHandler;
 ...
 * when the field detailPO value in the class ExamplePO is null,
 * or {@link NullableObject#isNull()} return true,
 * it will set "{}" into postgresql.
 * </pre>
 * </em></strong>
 *
 ...
 */
public class JdbcJsonbMappingJavaEntityTypeHandler<T extends NullableObject> extends JdbcJsonbMappingJavaObjectTypeHandler<T> {
