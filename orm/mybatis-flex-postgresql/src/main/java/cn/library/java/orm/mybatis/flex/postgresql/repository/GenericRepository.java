package cn.library.java.orm.mybatis.flex.postgresql.repository;

import cn.library.java.contract.model.base.PO;
import cn.library.java.contract.model.base.POJO;
import cn.library.java.orm.mybatis.flex.base.cache.MybatisFlexSystemCache;
import cn.library.java.orm.mybatis.flex.base.cache.MybatisFlexSystemCacheDTO;
import cn.library.java.orm.mybatis.flex.base.chain.QueryChain;
import cn.library.java.orm.mybatis.flex.postgresql.chain.JsonbQueryChainer;
import cn.library.java.orm.mybatis.flex.postgresql.chain.NormalQueryChainer;
 ...
 */
public interface GenericRepository<P extends PO> extends cn.library.java.orm.mybatis.flex.base.repository.GenericRepository<P> {
