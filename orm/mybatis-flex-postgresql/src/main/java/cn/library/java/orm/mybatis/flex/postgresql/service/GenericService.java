...
public class GenericService<P extends PO, V extends VO, R extends GenericRepository<P>> extends cn.library.java.orm.mybatis.flex.base.service.GenericService<P, V, R> {
