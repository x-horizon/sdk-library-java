...
// @AllArgsConstructor
public class JsonbQueryCaster2<PJ1 extends POJO, PJ2 extends POJO, PJ3 extends POJO, P extends PO> {

    private final SqlConnector sqlConnector;

    private final JsonbQueryChainer2<PJ1, P> jsonbQueryChainer;
    ...
    public JsonbQueryCaster2(SqlConnector sqlConnector, JsonbQueryChainer2<PJ1, P> jsonbQueryChainer, QueryChain<PJ1> nativeQueryChain, ColumnNameGetter<PJ2> columnNameGetter) {
    ...
    public JsonbQueryCaster2(SqlConnector sqlConnector, JsonbQueryChainer2<PJ1, P> jsonbQueryChainer, QueryChain<PJ1> nativeQueryChain, ColumnNameGetter<PJ2> columnNameGetter, ColumnNameGetter<PJ3> jsonKeyNameGetter) {
        this(sqlConnector, jsonbQueryChainer, nativeQueryChain, columnNameGetter);
        this.jsonKeyNameGetter = jsonKeyNameGetter;
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToBoolean() {
        return toQueryConditional(PostgresqlDataType.BOOLEAN);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToSmallint() {
        return toQueryConditional(PostgresqlDataType.SMALLINT);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToInteger() {
        return toQueryConditional(PostgresqlDataType.INTEGER);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToBigint() {
        return toQueryConditional(PostgresqlDataType.BIGINT);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToDecimal() {
        return toQueryConditional(PostgresqlDataType.DECIMAL);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToNumberic() {
        return toQueryConditional(PostgresqlDataType.NUMERIC);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToReal() {
        return toQueryConditional(PostgresqlDataType.REAL);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToChar() {
        return toQueryConditional(PostgresqlDataType.CHAR);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToVarchar() {
        return toQueryConditional(PostgresqlDataType.VARCHAR);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToText() {
        return toQueryConditional(PostgresqlDataType.TEXT);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToTimestamp() {
        return toQueryConditional(PostgresqlDataType.TIMESTAMP);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToJson() {
        return toQueryConditional(PostgresqlDataType.JSON);
    }

    public QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> castToJsonb() {
        return toQueryConditional(PostgresqlDataType.JSONB);
    }

    private QueryConditional<JsonbQueryChainer2<PJ1, P>, QueryChain<PJ1>> toQueryConditional(PostgresqlDataType dataType) {
