...
//
//     private ColumnNameGetter<PJ3> jsonKeyGetter;
//
...
//     }
//
//     public JsonbQueryCaster(SqlConnector sqlConnector, JsonbQueryChainer<PJ1, P> jsonbQueryChainer, QueryChain<PJ1> nativeQueryChain, ColumnNameGetter<PJ2> columnNameGetter, ColumnNameGetter<PJ3> jsonKeyGetter) {
...
//     }
//
//     private String getJsonKeyConditionSql(PostgresqlDataType dataType, ColumnNameGetter<PJ2> columnNameGetter, ColumnNameGetter<PJ3> jsonKeyGetter) {
//         return Strings.format("({} ->> '{}')::{}", getJsonQueryColumnName(columnNameGetter), MybatisFlexs.getFieldName(jsonKeyGetter), dataType.getValue());
//     }
//
