...
public class ConstrainedUpdateChain<T extends PO> extends QueryWrapperAdapter<ConstrainedUpdateChain<T>> implements PropertySetter<ConstrainedUpdateChain<T>> {
    ...
    public ConstrainedUpdateChain<T> set(QueryColumn queryColumn, Object value) {
        return setIfCondition(queryColumn, value, true);
    }

    public ConstrainedUpdateChain<T> setIfNotNull(QueryColumnValueGetter<T> queryColumnValueGetter, Object value) {
        return setIfCondition(queryColumnValueGetter, value, If::notNull);
    }

    public ConstrainedUpdateChain<T> setIfNotNull(QueryColumn queryColumn, Object value) {
        return setIfCondition(queryColumn, value, If::notNull);
    }

    public ConstrainedUpdateChain<T> setIfNotZeroValue(QueryColumnValueGetter<T> queryColumnValueGetter, Number value) {
        return setIfCondition(queryColumnValueGetter, value, If::notZeroValue);
    }

    public ConstrainedUpdateChain<T> setIfNotZeroValue(QueryColumn queryColumn, Number value) {
        return setIfCondition(queryColumn, value, If::notZeroValue);
    }

    public ConstrainedUpdateChain<T> setIfNotEmpty(QueryColumnValueGetter<T> queryColumnValueGetter, CharSequence value) {
        return setIfCondition(queryColumnValueGetter, value, If::notEmpty);
    }

    public ConstrainedUpdateChain<T> setIfNotEmpty(QueryColumn queryColumn, CharSequence value) {
        return setIfCondition(queryColumn, value, If::notEmpty);
    }

    public ConstrainedUpdateChain<T> setIfNotBlank(QueryColumnValueGetter<T> queryColumnValueGetter, CharSequence value) {
        return setIfCondition(queryColumnValueGetter, value, If::notBlank);
    }

    public ConstrainedUpdateChain<T> setIfNotBlank(QueryColumn queryColumn, CharSequence value) {
        return setIfCondition(queryColumn, value, If::notBlank);
    }

    public ConstrainedUpdateChain<T> setIfCondition(QueryColumnValueGetter<T> queryColumnValueGetter, Object value, BooleanSupplier condition) {
        return setIfCondition(queryColumnValueGetter, value, condition.getAsBoolean());
    }

    public ConstrainedUpdateChain<T> setIfCondition(QueryColumn queryColumn, Object value, BooleanSupplier condition) {
        return setIfCondition(queryColumn, value, condition.getAsBoolean());
    }

    public <U> ConstrainedUpdateChain<T> setIfCondition(QueryColumnValueGetter<T> queryColumnValueGetter, U value, Predicate<U> condition) {
        return setIfCondition(queryColumnValueGetter, value, condition.test(value));
    }

    public <U> ConstrainedUpdateChain<T> setIfCondition(QueryColumn queryColumn, U value, Predicate<U> condition) {
        return setIfCondition(queryColumn, value, condition.test(value));
    }

    public ConstrainedUpdateChain<T> setIfCondition(QueryColumnValueGetter<T> queryColumnValueGetter, Object value, boolean condition) {
        return setIfCondition(MybatisFlexs.getQueryColumn(queryColumnValueGetter), value, condition);
    }

    public ConstrainedUpdateChain<T> setIfCondition(QueryColumn queryColumn, Object value, boolean condition) {
