...
/**
 * is the same as {@link JavaListObjectMappingJdbcJsonbTypeHandler} and the generic is {@link Long}
 *
 * @author wjm
 * @since 2023-06-14 09:20:17
 */
public class JavaListLongMappingJdbcJsonbTypeHandler extends BaseTypeHandler<List<Long>> implements JdbcJsonbTypeHandler2<Long> {
