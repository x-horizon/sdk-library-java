 ...
 *
 *      public class ExampleJsonArrayMappingJsonbTypeHandler&lt;T&gt; extends {@link JavaListObjectMappingJdbcJsonbTypeHandler} {
 *
 *          &#064;Override
 *          public Class&lt;T&gt; {@link JavaListObjectMappingJdbcJsonbTypeHandler#getTargetClass()} {
 ...
 */
public class JavaListObjectMappingJdbcJsonbTypeHandler<T extends NullableObject> extends BaseTypeHandler<List<T>> implements JdbcJsonbTypeHandler2<T> {
