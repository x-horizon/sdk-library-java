package org.horizon.library.java.orm.contract.mybatis.base.cache;
...
public abstract class ColumnMappingJavaTypeCache {
    ...
    /**
     * the database column name and java type mapping cache, like: {"detail_info": [org.horizon.library.java.test.DetailPO]}
     */
