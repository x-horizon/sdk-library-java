...
import cn.srd.library.java.tool.constant.core.DatabaseType;
...
@Documented
@Inherited
@ConditionalOnProperty(name = "library.java.orm.mybatis-plus.database", havingValue = DatabaseType.POSTGRE_SQL)
