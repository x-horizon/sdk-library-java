package cn.srd.library.java.orm.mybatis.plus.database.postgresql.metadata.handler;

import cn.srd.library.java.doc.knife4j.model.PageParam;
import cn.srd.library.java.doc.knife4j.model.PageResult;
import cn.srd.library.java.orm.mybatis.plus.core.GenericCurdService;
import cn.srd.library.java.orm.mybatis.plus.core.MpWrappers;
import cn.srd.library.java.orm.mybatis.plus.database.postgresql.metadata.bean.convert.PostgresqlTableConverter;
import cn.srd.library.java.orm.mybatis.plus.database.postgresql.metadata.bean.dto.PostgresqlTableDTO;
import cn.srd.library.java.orm.mybatis.plus.database.postgresql.metadata.bean.po.PostgresqlTablePO;
import cn.srd.library.java.orm.mybatis.plus.database.postgresql.metadata.bean.vo.PostgresqlTableVO;
import cn.srd.library.java.orm.mybatis.plus.database.postgresql.metadata.dao.PostgresqlTableDao;
