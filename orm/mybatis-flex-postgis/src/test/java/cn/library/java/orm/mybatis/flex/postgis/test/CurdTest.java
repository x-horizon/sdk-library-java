package cn.library.java.orm.mybatis.flex.postgis.test;
...
import cn.library.java.orm.mybatis.flex.postgis.config.TestInsertListener;
import cn.library.java.orm.mybatis.flex.postgis.config.TestUpdateListener;
import cn.library.java.orm.mybatis.flex.postgis.model.po.HomePO;
import cn.library.java.orm.mybatis.flex.postgis.repository.HomeRepository;
...
@MapperScan("cn.library.java.orm.mybatis.flex.postgis.**")
...
@EnableMybatisFlexCustomizer(
        ...
        globalPropertyConfig = @PropertyConfig(
                ...
                xmlMapperClassPaths = {"classpath*:cn/library/java/orm/mybatis/flex/postgis/repository/impl/*.xml"},
