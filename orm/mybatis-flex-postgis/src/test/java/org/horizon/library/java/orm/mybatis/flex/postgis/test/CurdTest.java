package org.horizon.library.java.orm.mybatis.flex.postgis.test;
...
import org.horizon.library.java.orm.mybatis.flex.postgis.config.TestInsertListener;
import org.horizon.library.java.orm.mybatis.flex.postgis.config.TestUpdateListener;
import org.horizon.library.java.orm.mybatis.flex.postgis.model.po.HomePO;
import org.horizon.library.java.orm.mybatis.flex.postgis.repository.HomeRepository;
import org.horizon.library.java.tool.geometry.Geometries;
...
@MapperScan("org.horizon.library.java.orm.mybatis.flex.postgis.**")
...
@EnableMybatisFlexCustomizer(
        ...
        globalPropertyConfig = @PropertyConfig(
                ...
                xmlMapperClassPaths = {"classpath*:org/horizon/library/java/orm/mybatis/flex/postgis/repository/impl/*.xml"},
