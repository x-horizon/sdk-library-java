package cn.library.java.orm.contract.autoconfigure;

import cn.library.java.tool.enums.autoconfigure.EnableEnumAutowired;
import org.springframework.boot.autoconfigure.AutoConfiguration;
import org.springframework.boot.autoconfigure.EnableAutoConfiguration;

import static cn.library.java.orm.contract.autoconfigure.ORMContractBasePackagePathAutoConfigurer.BASE_PACKAGE_PATH;
