...
/**
 * <p>mysql jdbc json array type and java list entity mapping handler.</p>
 *
 ...
 *    detail_infos JSON   DEFAULT (JSON_ARRAY()) NOT NULL -- Example: [{"name":"myName1","age":18},{"name":"myName2","age":18}]
 * );
 *         }</pre>
 *     </li>
 *
 ...
 */
public class JdbcJsonMappingJavaListEntityTypeHandler<T> extends AbstractJdbcJsonMappingJavaListEntityTypeHandler<T, String> implements MysqlComplexTypeConverter {
