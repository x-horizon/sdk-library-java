 ...
 */
public class JdbcUuidTypeMappingJavaStringHandler extends BaseTypeHandler<String> {
    ...
    public void setNonNullParameter(PreparedStatement preparedStatement, int columnIndex, String parameter, JdbcType jdbcType) {
        preparedStatement.setObject(columnIndex, Nil.isBlank(parameter) ? null : UUID.fromString(parameter));
    }
