...
import cn.srd.itcp.sugar.component.lock.redisson.common.core.RedissonNonFairLock;
...
public class RedissonNonFairLockAspect extends RedissonLockAspectSupporter {
     ...
     * 切点声明
     */
    @Pointcut("@annotation(cn.srd.itcp.sugar.component.lock.redisson.common.core.RedissonNonFairLock)")
