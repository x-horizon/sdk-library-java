...
public class RedisFairLockAspect extends RedisLockAspectSupporter {
     ...
     * instance
     */
    private static RedisFairLockAspect instance = null;
     ...
     * @return instance
     */
    public static RedisFairLockAspect getInstance() {
        return instance;
    }
     ...
     * 切点声明
     */
    @Pointcut("@annotation(cn.srd.itcp.sugar.component.lock.redis.common.core.RedisFairLock)")
