package cn.srd.itcp.sugar.cache.redisson.support.lock;

import cn.srd.itcp.sugar.cache.redisson.core.lock.RedissonNonFairLock;
...
public class RedissonNonFairLockAspect extends RedissonLockAspectSupporter {
     ...
     * 切点声明
     */
    @Pointcut("@annotation(cn.srd.itcp.sugar.cache.redisson.core.lock.RedissonNonFairLock)")
