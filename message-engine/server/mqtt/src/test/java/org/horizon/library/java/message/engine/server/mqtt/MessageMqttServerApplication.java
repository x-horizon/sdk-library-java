package org.horizon.library.java.message.engine.server.mqtt;

import com.mybatisflex.core.logicdelete.impl.DateTimeLogicDeleteProcessor;
import org.apache.ibatis.logging.nologging.NoLoggingImpl;
import org.horizon.library.java.message.engine.server.mqtt.autoconfigure.EnableMessageMqttServer;
 ...
 */
@MapperScan("org.horizon.library.java.message.engine.server.**.repository")
...
@EnableMybatisFlexCustomizer(
        ...
        globalPropertyConfig = @PropertyConfig(
                ...
                xmlMapperClassPaths = {"classpath*:org/horizon/library/java/message/engine/server/mqtt/repository/impl/*.xml"}
                // xmlMapperEntityPackageAliasPackagePaths = {"org.horizon.library.java.message.engine.server.**.model.**"}
        )
)
