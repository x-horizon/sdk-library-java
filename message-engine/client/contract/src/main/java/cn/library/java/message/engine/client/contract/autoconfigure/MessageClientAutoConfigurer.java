package cn.library.java.message.engine.client.contract.autoconfigure;

import cn.library.java.message.engine.client.contract.aspect.MessageConsumerAspect;
import cn.library.java.message.engine.client.contract.aspect.MessageProducerAspect;
import cn.library.java.message.engine.client.contract.event.MessageClientConfigEvent;
