...
import cn.library.java.message.engine.client.contract.support.MessageClientFlows;
import cn.library.java.message.engine.client.kafka.KafkaConfig;
import cn.library.java.message.engine.client.kafka.model.dto.KafkaClientConfigDTO;
import cn.library.java.message.engine.client.kafka.model.enums.KafkaConsumerAdapterAckMode;
import cn.library.java.message.engine.client.kafka.model.enums.KafkaConsumerAdapterListenerMode;
import cn.library.java.message.engine.client.kafka.model.property.KafkaClientProperty;
