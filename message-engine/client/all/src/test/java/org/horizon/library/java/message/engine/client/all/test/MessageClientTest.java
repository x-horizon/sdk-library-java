package org.horizon.library.java.message.engine.client.all.test;

import org.horizon.library.java.message.engine.client.kafka.autoconfigure.EnableMessageKafkaClient;
import org.horizon.library.java.message.engine.client.mqtt.v3.autoconfigure.EnableMessageMqttV3Client;
import lombok.SneakyThrows;
import org.horizon.library.java.message.engine.client.all.foo.FooProducer;
