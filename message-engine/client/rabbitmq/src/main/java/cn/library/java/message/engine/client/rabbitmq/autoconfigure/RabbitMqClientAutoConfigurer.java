package cn.library.java.message.engine.client.rabbitmq.autoconfigure;

import cn.library.java.message.engine.client.rabbitmq.model.property.RabbitMqClientProperty;
import cn.library.java.message.engine.client.rabbitmq.strategy.RabbitMqClientConfigStrategy;
import cn.library.java.message.engine.client.rabbitmq.strategy.RabbitMqClientFlowStrategy;
