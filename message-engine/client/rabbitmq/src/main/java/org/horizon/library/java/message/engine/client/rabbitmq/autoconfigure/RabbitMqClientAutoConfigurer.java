package org.horizon.library.java.message.engine.client.rabbitmq.autoconfigure;

import org.horizon.library.java.message.engine.client.rabbitmq.model.property.RabbitMqClientProperty;
import org.horizon.library.java.message.engine.client.rabbitmq.strategy.RabbitMqClientConfigStrategy;
import org.horizon.library.java.message.engine.client.rabbitmq.strategy.RabbitMqClientFlowStrategy;
