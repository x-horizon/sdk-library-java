 ...
 */
public class MessageEngineRabbitMqStrategy implements MessageEngineStrategy {

    @Override
    public MessageEngineRabbitMqStrategy registerProducerFlowIfNeed(String flowId, MessageProducer messageProducerAnnotation) {
