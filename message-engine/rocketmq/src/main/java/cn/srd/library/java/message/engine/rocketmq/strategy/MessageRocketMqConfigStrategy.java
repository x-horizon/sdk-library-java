 ...
 */
@Slf4j
public class MessageRocketMqConfigStrategy extends MessageConfigStrategy<MessageRocketMqProperties, MessageRocketMqConfigDTO, MessageRocketMqConfigDTO.BrokerDTO, MessageRocketMqConfigDTO.ClientDTO, MessageRocketMqConfigDTO.ProducerDTO, MessageRocketMqConfigDTO.ConsumerDTO> {

    @Override
    protected MessageVerificationConfigDTO getVerificationConfigDTO(MessageRocketMqConfigDTO configDTO) {
    ...
    @Override
    protected Class<MessageRocketMqProperties> getPropertiesType() {
        throw new UnsupportedException();
    }
    ...
    @Override
    protected void registerProducerFactory(MessageRocketMqConfigDTO.ProducerDTO producerDTO) {
        throw new UnsupportedException();
    }
