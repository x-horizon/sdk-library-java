package org.horizon.sdk.library.java.message.engine.contract.autoconfigure;
...
public class MessageEngineBasePackagePathAutoConfigurer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public static final String BASE_PACKAGE_PATH = "org.horizon.sdk.library.java.message.engine";
