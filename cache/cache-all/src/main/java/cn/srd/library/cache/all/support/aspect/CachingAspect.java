...
import cn.srd.library.cache.all.core.CacheEvict;
import cn.srd.library.cache.all.core.CacheWrite;
import cn.srd.library.cache.all.core.Caching;
...
public class CachingAspect implements CacheAspect {
     ...
     */
    @Pointcut("@annotation(cn.srd.library.cache.all.core.Caching)")
