package cn.srd.library.java.cache.redis.support;

import cn.srd.library.java.contract.cache.redis.config.properties.RedisCacheProperties;
...
/**
 * {@link EnableAutoConfiguration AutoConfiguration} for Library Cache Redis TODO wjm 未解决存对象入 redis 后乱码的问题：使用 JsonJacksonCodec，序列化相关注解重写 serializeWithType，序列化成功，但 redis 依然乱码，且反序列化从 redis 取数据失败
 *
 * @author wjm
