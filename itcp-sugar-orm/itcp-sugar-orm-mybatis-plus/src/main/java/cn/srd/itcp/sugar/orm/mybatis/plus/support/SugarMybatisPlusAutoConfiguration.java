...
import cn.srd.itcp.sugar.orm.mybatis.plus.database.mysql.utils.MysqlBinaryPrimaryKeyGenerator;
...
public class SugarMybatisPlusAutoConfiguration {
     ...
     * TODO wjm 目前若在配置文件里开启了 sugar-mybatis-plus-enable 属性，则必须手工扫描：@MapperScan({"cn.srd.itcp.sugar.orm.mybatis.plus.database.postgresql.metadata.dao"})，后续需要自动化
     *
     * @return 装配对象
     */
    @Bean
