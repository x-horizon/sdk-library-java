package cn.srd.library.java.concurrent.redis.support;

import cn.srd.library.java.concurrent.redis.RedisNonFairLock;
...
public class RedisNonFairLockAspect extends RedisLockAspect {
     ...
     * 切点声明
     */
    @Pointcut("@annotation(cn.srd.library.java.concurrent.redis.RedisNonFairLock)")
