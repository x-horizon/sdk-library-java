package cn.library.java.oss.api.test;

import cn.library.java.contract.constant.suppress.SuppressWarningConstant;
import cn.library.java.oss.contract.Oss;
import cn.library.java.oss.contract.model.domain.OssFileDO;
import cn.library.java.oss.local.autoconfigure.EnableOssLocal;
import cn.library.java.oss.minio.autoconfigure.EnableOssMinio;
