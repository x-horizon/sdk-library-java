...
import cn.srd.itcp.sugar.cache.redisson.common.core.lock.RedissonNonFairLock;
...
public class RedissonNonFairLockAspect extends RedissonLockAspectSupporter {
     ...
     * 切点声明
     */
    @Pointcut("@annotation(cn.srd.itcp.sugar.cache.redisson.common.core.lock.RedissonNonFairLock)")
