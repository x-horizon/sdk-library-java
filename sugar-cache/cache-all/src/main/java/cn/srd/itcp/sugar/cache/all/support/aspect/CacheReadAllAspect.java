...
import cn.srd.itcp.sugar.cache.all.core.CacheReadAll;
...
public class CacheReadAllAspect implements CacheAspect {
     ...
     */
    @Pointcut("@annotation(cn.srd.itcp.sugar.cache.all.core.CacheReadAll)")
    ...
    public <V> List<V> aroundPointcut(ProceedingJoinPoint joinPoint) {
        ...
        CacheAspectContext context = buildCacheReadAllContext(joinPoint, annotation.namespaces(), annotation.cacheComponentTypes(), annotation.key(), annotation.allowNullValue());
