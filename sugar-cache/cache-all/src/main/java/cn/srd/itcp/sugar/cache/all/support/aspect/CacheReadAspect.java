...
public class CacheReadAspect implements CacheAspect {
    ...
    public Object aroundPointcut(ProceedingJoinPoint joinPoint) {
        ...
        CacheAspectContext context = buildCacheReadContext(joinPoint, annotation.namespaces(), annotation.cacheComponentTypes(), annotation.keyGenerator(), annotation.key(), annotation.allowNullValue());
