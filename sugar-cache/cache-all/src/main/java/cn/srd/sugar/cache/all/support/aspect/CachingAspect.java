...
import cn.srd.sugar.cache.all.core.CacheEvict;
import cn.srd.sugar.cache.all.core.CacheWrite;
import cn.srd.sugar.cache.all.core.Caching;
...
public class CachingAspect implements CacheAspect {
     ...
     */
    @Pointcut("@annotation(cn.srd.sugar.cache.all.core.Caching)")
