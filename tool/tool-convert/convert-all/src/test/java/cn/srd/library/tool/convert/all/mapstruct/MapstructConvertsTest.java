package cn.srd.library.tool.convert.all.mapstruct;

import cn.srd.library.tool.convert.all.core.Converts;
import cn.srd.library.tool.convert.all.mapstruct.bean.domain.GradeDO;
import cn.srd.library.tool.convert.all.mapstruct.bean.domain.StudentDO;
import cn.srd.library.tool.convert.all.mapstruct.bean.domain.StudentUnsupportedMapstructConvertDO;
import cn.srd.library.tool.convert.all.mapstruct.bean.vo.GradeVO;
import cn.srd.library.tool.convert.all.mapstruct.bean.vo.StudentUnsupportedMapstructConvertVO;
import cn.srd.library.tool.convert.all.mapstruct.bean.vo.StudentVO;
import cn.srd.library.tool.convert.mapstruct.exception.MapstructConvertMethodNotFoundException;
import cn.srd.library.tool.convert.mapstruct.exception.MapstructConvertMethodUnsupportedException;
