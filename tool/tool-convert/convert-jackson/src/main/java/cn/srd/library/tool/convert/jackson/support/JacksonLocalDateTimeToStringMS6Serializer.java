...
/**
 * Jackson 序列化处理器：LocalDateTime =&gt; String，如：2011-12-03 10:15:30.974515
 *
 * @author wjm
 * @since 2023-07-27 21:50:19
 */
public class JacksonLocalDateTimeToStringMS6Serializer extends JsonSerializer<LocalDateTime> {

    @Override
    @SneakyThrows
    public void serialize(LocalDateTime from, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.writeObject(TimeUtil.toStringWithDateTimeMS6(from));
    }
