package cn.srd.library.tool.convert.mapstruct.utils;

import cn.srd.library.tool.constant.core.StringPool;
import cn.srd.library.tool.lang.core.*;
import cn.srd.library.tool.lang.core.algorithm.AlgorithmsUtil;
...
public class MapstructMappingManager {
    ...
    public static List<Integer> parseHighestOneBit(Integer value) {
        return AlgorithmsUtil.parseHighestOneBit(value);
    }
