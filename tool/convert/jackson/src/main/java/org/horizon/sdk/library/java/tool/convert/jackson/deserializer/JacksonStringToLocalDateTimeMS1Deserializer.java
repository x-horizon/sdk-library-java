...
/**
 * the jackson deserializer to convert {@link String} like "2023-03-27 21:41:07.7" to {@link LocalDateTime}
 *
 * @author wjm
...
public class JacksonStringToLocalDateTimeMS1Deserializer extends StdConverter<String, LocalDateTime> {
    ...
    public LocalDateTime convert(String from) {
        return Times.toLocalDateTime(from, TimePatternConstant.DATETIME_MS1);
    }
