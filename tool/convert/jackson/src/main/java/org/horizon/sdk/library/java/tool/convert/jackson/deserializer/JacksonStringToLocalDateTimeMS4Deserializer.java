 ...
 */
public class JacksonStringToLocalDateTimeMS4Deserializer extends JsonDeserializer<LocalDateTime> {

    @SneakyThrows
    @Override
    public LocalDateTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        return Times.toLocalDateTime(jsonParser.getValueAsString(), TimePatternConstant.DATETIME_MS4);
    }
