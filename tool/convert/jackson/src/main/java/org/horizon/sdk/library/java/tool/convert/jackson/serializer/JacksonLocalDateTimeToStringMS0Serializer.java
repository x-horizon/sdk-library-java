 ...
 */
public class JacksonLocalDateTimeToStringMS0Serializer extends JacksonSerializeToStringSerializer<LocalDateTime, String> {

    @Override
    public String getTargetValue(LocalDateTime sourceValue) {
        return Times.toStringWithDateTimeMS0(sourceValue);
    }
