 ...
 */
public class JacksonStringToLocalDateTimeRFC3339Deserializer extends JsonDeserializer<LocalDateTime> {

    @SneakyThrows
    @Override
    public LocalDateTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        return Times.toLocalDateTime(jsonParser.getValueAsString(), TimePatternConstant.DATETIME_RFC3339_EAST_EIGHTH_TIMEZONE);
    }
