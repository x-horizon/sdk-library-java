...
/**
 * the jackson serializer to convert {@code List<Enum<E>>} to {@code List<the enum internal int value>}, see {@link Enums#getFieldValue(Enum, Class)}
 *
 * @author wjm
 * @since 2022-09-16 16:24
 */
public class JacksonListEnumToListIntegerSerializer<E extends Enum<E>> extends JacksonSerializeToArraySerializer<List<Enum<E>>, List<Integer>> {
