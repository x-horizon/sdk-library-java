...
import cn.srd.library.java.tool.constant.core.CharPool;
...
public class CollectionsUtil extends CollUtil {
    ...
    public static <K, V> K getFirstKey(@Nullable Map<K, V> from) {
        return Objects.isNotEmpty(from) ? CollUtil.getFirst(from.keySet()) : null;
    }
    ...
    public static <T, U extends Comparable<? super U>> T getAscFirst(@NonNull Collection<T> from, @NonNull Function<T, U> function) {
        return CollUtil.getFirst(asc(from, function));
    }
    ...
    public static <T, U extends Comparable<? super U>> T getDescFirst(@NonNull Collection<T> from, @NonNull Function<T, U> function) {
        return CollUtil.getFirst(desc(from, function));
    }
    ...
    public static <T> Optional<T> getOptionalFirst(Iterable<T> from) {
        return Optional.ofNullable(CollUtil.getFirst(from));
    }
    ...
    public static <T> Optional<T> getOptionalLast(Collection<T> from) {
        return Optional.ofNullable(CollUtil.getLast(from));
    }
    ...
    public static boolean notContains(Collection<?> from, Object object) {
        return !CollUtil.contains(from, object);
    }
    ...
    public static <T> boolean notContains(Collection<T> from, Predicate<? super T> containLogic) {
        return !CollUtil.contains(from, containLogic);
    }
