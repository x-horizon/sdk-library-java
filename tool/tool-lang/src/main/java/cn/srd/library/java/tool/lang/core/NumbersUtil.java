...
import cn.srd.library.java.tool.constant.core.TimePool;
...
public class NumbersUtil extends NumberUtil {
    ...
    public static double kilometersPerHourToMeterPerSecond(long input) {
        return NumberUtil.div(NumberUtil.mul(input, ONE_THOUSAND), TimePool.ONE_HOUR_SECOND);
    }
    ...
    public static BigDecimal roundWithScale0ToBigDecimal(double input) {
        return NumberUtil.round(input, ZERO_SCALE);
    }
    ...
    public static BigDecimal addRoundWithScale0ToBigDecimal(double input1, double input2) {
        return NumberUtil.add(Double.toString(input1), Double.toString(input2)).setScale(ZERO_SCALE, RoundingMode.HALF_UP);
    }
    ...
    public static BigDecimal subRoundWithScale0ToBigDecimal(double input1, double input2) {
        return NumberUtil.sub(Double.toString(input1), Double.toString(input2)).setScale(ZERO_SCALE, RoundingMode.HALF_UP);
    }
    ...
    public static BigDecimal mulRoundWithScale0ToBigDecimal(float input1, double input2) {
        return NumberUtil.mul(Float.toString(input1), Double.toString(input2)).setScale(ZERO_SCALE, RoundingMode.HALF_UP);
    }
    ...
    public static BigDecimal divRoundWithScale0ToBigDecimal(double input1, double input2) {
        return NumberUtil.div(Double.toString(input1), Double.toString(input2)).setScale(ZERO_SCALE, RoundingMode.HALF_UP);
    }
