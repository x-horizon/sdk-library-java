...
import cn.library.java.contract.constant.classes.ClassConstant;
import cn.library.java.contract.constant.module.ModuleView;
import cn.library.java.contract.constant.text.SymbolConstant;
import cn.library.java.contract.constant.web.ProtocolConstant;
...
public class Classes extends cn.library.java.tool.lang.object.Classes {
     ...
     * @see cn.library.java.tool.lang.object.Classes#getTheLargestRangePackagePath(Collection)
     */
    public static Set<String> getTheLargestRangePackagePath(Collection<String> packagePaths) {
        return cn.library.java.tool.lang.object.Classes.getTheLargestRangePackagePath(parseAntStylePackagePathsToPackagePaths(packagePaths));
    }
     ...
     * @see cn.library.java.tool.lang.object.Classes#scanByAnnotation(Class, String...)
     */
    public static Set<Class<?>> scanByAnnotation(Class<? extends Annotation> annotationClass) {
        return Try.of(() -> cn.library.java.tool.lang.object.Classes.scanByAnnotation(annotationClass, Springs.getSpringBootApplicationPackagePath())).getOrElse(Collections.newHashSet());
    }
     ...
     * @apiNote this function scans every time and has poor performance, recommended to use {@link #scanByTypeFilter(Collection, Collection)} function.
     * @see cn.library.java.tool.lang.object.Classes#scanBySuper(Class, String...)
     */
    public static <T> Set<Class<? extends T>> scanBySuper(Class<T> rootClass) {
        return Try.of(() -> cn.library.java.tool.lang.object.Classes.scanBySuper(rootClass, Springs.getSpringBootApplicationPackagePath())).getOrElse(Collections.newHashSet());
    }
