...
import org.horizon.library.java.contract.constant.annotation.AnnotationConstant;
import org.horizon.library.java.contract.constant.classes.ClassConstant;
...
import org.horizon.library.java.contract.constant.web.ProtocolConstant;
...
public class Classes extends org.horizon.library.java.tool.lang.object.Classes {
     ...
     * // "org.horizon.library" is contain "org.horizon.library.xxx", "org.horizon.library.ss.xx", so keep only "org.horizon.library".
     * // "cn.core"    not contain the other package path, so keep it.
     * // the output is ["cn.test", "org.horizon.library", "cn.core"]
     * Classes.getTheMostLargerRangePackagePath(List.of("cn.test.lang1", "cn.test.lang1", "cn.test", "org.horizon.library", "org.horizon.library.xxx", "org.horizon.library.ss.xx", "cn.core"));
     *
     * // example 2:
     ...
     * // all package paths start with "org.horizon.library", and although the second package name is inconsistent, it will also be filtered out.
     * // the output is ["org.horizon.library"]
     * Classes.getTheMostLargerRangePackagePath(List.of("org.horizon.library.lang1", "org.horizon.library.lang1", "org.horizon.library", "org.horizon.library2", "org.horizon.library2.xxx", "org.horizon.library2.ss.xx", "org.horizon.library3"));
     * }
     * </pre>
     *
     * @param packagePaths the package paths
     * @return the largest range package paths
     * @see org.horizon.library.java.tool.lang.object.Classes#getTheLargestRangePackagePath(Collection)
     */
    public static Set<String> getTheLargestRangePackagePath(Collection<String> packagePaths) {
        return org.horizon.library.java.tool.lang.object.Classes.getTheLargestRangePackagePath(parseAntStylePackagePathsToPackagePaths(packagePaths));
    }
     ...
     * @see org.horizon.library.java.tool.lang.object.Classes#scanByAnnotation(Class, String...)
     */
    public static Set<Class<?>> scanByAnnotation(Class<? extends Annotation> annotationClass) {
        return Try.of(() -> org.horizon.library.java.tool.lang.object.Classes.scanByAnnotation(annotationClass, Springs.getSpringBootApplicationPackagePath())).getOrElse(Collections.newHashSet());
    }
     ...
     * @apiNote this function scans every time and has poor performance, recommended to use {@link #scanByTypeFilter(Collection, Collection)} function.
     * @see org.horizon.library.java.tool.lang.object.Classes#scanBySuper(Class, String...)
     */
    public static <T> Set<Class<? extends T>> scanBySuper(Class<T> rootClass) {
        return Try.of(() -> org.horizon.library.java.tool.lang.object.Classes.scanBySuper(rootClass, Springs.getSpringBootApplicationPackagePath())).getOrElse(Collections.newHashSet());
    }
     ...
     * the input is "org.horizon.library.java.tool.spring.base.Classes", the output is "org/horizon/library/java/tool/spring/base/Classes".
     * </pre>
     *
     ...
     * the input is "org.horizon.library.java.tool.spring.base.Classes", the output is "classpath*:org/horizon/library/java/tool/spring/base/Classes".
     * </pre>
     *
     * @param className the class name
